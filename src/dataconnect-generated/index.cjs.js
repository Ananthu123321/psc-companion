...
const listTopicsBySubjectRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'ListTopicsBySubject', inputVars);
}
listTopicsBySubjectRef.operationName = 'ListTopicsBySubject';
exports.listTopicsBySubjectRef = listTopicsBySubjectRef;

exports.listTopicsBySubject = function listTopicsBySubject(dcOrVars, varsOrOptions, options) {
...
const recordUserAttemptRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'RecordUserAttempt', inputVars);
}
recordUserAttemptRef.operationName = 'RecordUserAttempt';
exports.recordUserAttemptRef = recordUserAttemptRef;

exports.recordUserAttempt = function recordUserAttempt(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
